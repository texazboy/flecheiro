...
- Sprites do personagem: **Pixel Adventure** por *Pixel Frog* — licença CC0
  ([itch.io](https://pixelfrog-assets.itch.io/pixel-adventure-1)). Cenário, itens
  e NPCs são desenhados proceduralmente pelo próprio jogo.
